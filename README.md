...
1. Abrir el notebook directamente desde GitHub en Colab:
   - Ir a [colab.research.google.com](https://colab.research.google.com)
   - `Archivo → Abrir notebook → GitHub`
   - Pegar la URL del repositorio: `https://github.com/TU_USUARIO/TU_REPO`
   - Seleccionar `delivery_promise_challenge_v2.ipynb`

2. Ejecutar todas las celdas en orden:
   - `Entorno de ejecución → Ejecutar todo` (o `Ctrl+F9`)
   - La primera celda clona el repositorio automáticamente y carga el dataset — no requiere intervención manual
