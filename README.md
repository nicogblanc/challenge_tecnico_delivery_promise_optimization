...
| LGBM final (q20/q94) | **2.2146** | **2.3190** | 74.4% | **24.7 min** | **6.9%** |
| Mejora | **−20.4%** | **−12.2%** | −0.7pp | **−2.3 min** | **−2.2pp** |

### 10.2 Distribución del intervalo en test

| | T_low | T_high |
|---|---|---|
| Media | 21.6 min | 46.2 min |
| Mediana | 21.1 min | 45.8 min |
| Ancho promedio | — | **24.7 min** |
| Ancho p10-p90 | — | 20.2 – 29.5 min |
...
`SHIPPING_TYPE` tiene mayor impacto en q94 (1.9%) que en q20 (0.1%) — el tipo de logística afecta principalmente los casos extremos (cola superior), no los pedidos rápidos.

### 11.2 Ablation STORE_ID

| | Pinball q94 | Cobertura | Ancho | Late rate |
|---|---|---|---|---|
| Con STORE_ID | 2.3190 | 74.4% | 24.7 min | **6.9%** |
| Sin STORE_ID | 2.3207 | 72.7% | 23.2 min | 8.6% |

Sin STORE_ID la late rate sube de 6.9% a 8.6% (+1.7pp) — prácticamente al nivel del sistema actual (8.8%). Se mantiene STORE_ID porque el objetivo de negocio es reducir late rate.
...
|---|---|
| 0 min (inmediato) | 1.8% |
| 1 – 5 min post-checkout | 29.2% |
| 5 – 10 min post-checkout | 44.8% |
| > 10 min post-checkout | 24.2% |
| **Mediana** | **6.8 min** |
| **Media** | **7.4 min** |

T_low mediano: 21.1 min | Cooking mediano: 14.0 min | Diferencia media: 7.3 min
...
| coccion_media | 23m | 48m | 15m | 8m post-checkout |
| bebidas | 22m | 48m | 14m | 9m post-checkout |
...
### 15.3 Postura sobre el uso de IA en el contexto del rol
